...
const DEFAULT_PAIRS = [
  ...
  { s: 'XRP/USDT',      p: 0.62       }, { s: 'ADA/USDT',      p: 0.5        },
  { s: 'AVAX/USDT',     p: 38         }, { s: 'ATOM/USDT',     p: 8          },
  { s: 'LINK/USDT',     p: 14.5       }, { s: 'LTC/USDT',      p: 82         },
  { s: 'UNI/USDT',      p: 10.2       }, { s: 'NEAR/USDT',     p: 5.6        },
  { s: 'FIL/USDT',      p: 5.9        }, { s: 'VET/USDT',      p: 0.035      },
  { s: 'ICP/USDT',      p: 12.5       }, { s: 'THETA/USDT',    p: 1.65       },
  { s: 'EOS/USDT',      p: 0.82       }, { s: 'XLM/USDT',      p: 0.12       },
  { s: 'FTM/USDT',      p: 0.72       }, { s: 'SAND/USDT',     p: 0.42       },
  { s: 'MANA/USDT',     p: 0.38       }, { s: 'AXS/USDT',      p: 7          },
  { s: 'GALA/USDT',     p: 0.028      }, { s: 'CHZ/USDT',      p: 0.085      },
  { s: 'ZEC/USDT',      p: 29         }, { s: 'WAVES/USDT',    p: 2.1        },
  { s: 'NEO/USDT',      p: 12         }, { s: 'ONT/USDT',      p: 0.21       },
  { s: 'CAKE/USDT',     p: 2.6        }, { s: 'COMP/USDT',     p: 55         },
  { s: 'MKR/USDT',      p: 1650       }, { s: 'AAVE/USDT',     p: 100        },
  { s: 'SNX/USDT',      p: 2.8        }, { s: 'CRV/USDT',      p: 0.38       },
  { s: 'YFI/USDT',      p: 6800       }, { s: 'KNC/USDT',      p: 0.68       },
  { s: 'ZRX/USDT',      p: 0.41       }, { s: 'FET/USDT',      p: 1.65       },
  { s: 'STX/USDT',      p: 1.85       }, { s: 'OP/USDT',       p: 1.72       },
  { s: 'ARB/USDT',      p: 0.88       }, { s: 'SUI/USDT',      p: 1.52       },
  { s: 'SEI/USDT',      p: 0.38       }, { s: 'INJ/USDT',      p: 24         },
  { s: 'BONK/USDT',     p: 0.000025   }, { s: 'PEPE/USDT',     p: 0.0000088  },
  { s: 'FLOKI/USDT',    p: 0.000185   }, { s: 'CVX/USDT',      p: 2.8        },
  { s: 'GMX/USDT',      p: 22         }, { s: 'DYDX/USDT',     p: 1.42       },
  { s: 'IMX/USDT',      p: 1.65       }, { s: 'CELO/USDT',     p: 0.56       },
  { s: 'ALGO/USDT',     p: 0.18       }, { s: 'APE/USDT',      p: 1.2        },
  { s: 'ARC/USDT',      p: 0.1        }, { s: 'AERO/USDT',     p: 1.5        },
  { s: 'BCH/USDT',      p: 380        }, { s: 'BLUR/USDT',     p: 0.18       },
  { s: 'COTI/USDT',     p: 0.08       }, { s: 'DAI/USDT',      p: 1          },
  { s: 'DUSK/USDT',     p: 0.12       }, { s: 'EDU/USDT',      p: 0.35       },
  { s: 'EGLD/USDT',     p: 35         }, { s: 'ENA/USDT',      p: 0.45       },
  { s: 'ETC/USDT',      p: 20         }, { s: 'GTC/USDT',      p: 0.8        },
  { s: 'HBAR/USDT',     p: 0.07       }, { s: 'IOST/USDT',     p: 0.008      },
  { s: 'JUMP/USDT',     p: 0.02       }, { s: 'JUP/USDT',      p: 0.55       },
  { s: 'KCS/USDT',      p: 10         }, { s: 'LEVER/USDT',    p: 0.001      },
  { s: 'LENDO/USDT',    p: 0.1        }, { s: 'LOOKS/USDT',    p: 0.05       },
  { s: 'LUNC/USDT',     p: 0.00008    }, { s: 'LUNA/USDT',     p: 0.5        },
  { s: 'MASK/USDT',     p: 2.5        }, { s: 'MOVE/USDT',     p: 0.5        },
  { s: 'NOT/USDT',      p: 0.006      }, { s: 'ORDI/USDT',     p: 35         },
  { s: 'PY/USDT',       p: 0.38       }, { s: 'QNT/USDT',      p: 80         },
  { s: 'RAYS/USDT',     p: 2.5        }, { s: 'RSR/USDT',      p: 0.008      },
  { s: 'TAO/USDT',      p: 350        }, { s: 'THEA/USDT',     p: 0.5        },
  { s: 'TRB/USDT',      p: 60         }, { s: 'TUSD/USDT',     p: 1          },
  { s: 'USDC/USDT',     p: 1          }, { s: 'WBTC/USDT',     p: 65000      },
  { s: 'XEC/USDT',      p: 0.00003    }, { s: 'XTZ/USDT',      p: 0.8        },
  { s: 'ZETA/USDT',     p: 0.5        }, { s: 'BALANCER/USDT', p: 3          },
  { s: 'BUSD/USDT',     p: 1          },
];
